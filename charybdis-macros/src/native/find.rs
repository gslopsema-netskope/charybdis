...
pub(crate) fn find_all_function(
    ...
    quote! {
    pub fn find_all<'a>() -> charybdis::query::CharybdisQuery<'a, (), #struct_name, charybdis::query::ModelStream<Self>> {
            <#struct_name as charybdis::operations::Find>::find(&#query_str, ())
        }
    }
}
